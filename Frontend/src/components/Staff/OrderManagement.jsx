...
import { exportOrders } from "../../api/reportApi";
          ...
          <div className="flex justify-around items-center space-x-4 mx-10">
            ...
            <Card className="shadow-md p-4 w-full">
              ...
              <div className="flex items-center justify-start mb-2">
                <div className="flex items-center justify-start mb-2">
                  <FontAwesomeIcon icon={faBagShopping} className="text-orange-500 pr-2" />
                  <p className="text-xl font-bold">{formatPrice(activeAmount)}</p>
                </div>
                <div className="flex justify-between items-center w-full">
                  <p className="text-xl font-bold">({activeLength})</p>
                </div>
              </div>
            </Card>
            <Card className="shadow-md p-4 w-full">
              ...
              <div className="flex items-center justify-start mb-2">
                <div className="flex items-center justify-start mb-2">
                  <FontAwesomeIcon icon={faBagShopping} className="text-orange-500 pr-2" />
                  <p className="text-xl font-bold">{formatPrice(completedAmount)}</p>
                </div>
                <div className="flex justify-between items-center w-full">
                  <p className="text-xl font-bold">({completedLength})</p>
                </div>
              </div>
            </Card>
            <Card className="shadow-md p-4 w-full">
