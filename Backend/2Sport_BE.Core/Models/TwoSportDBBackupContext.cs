...
{
    public partial class TwoSportDBBackupContext : DbContext
    {
        public TwoSportDBBackupContext()
        {
        }

        public TwoSportDBBackupContext(DbContextOptions<TwoSportDBBackupContext> options)
            : base(options)
        {
        }
